...
execute_process(
  COMMAND "/usr/bin/git" show-ref "5c19fd7179855675b814da36fa5f160cf760600e"
  WORKING_DIRECTORY "/Users/lordzippy/Development/Noodles/NoodlesExplorer/build-src-Desktop_Qt_5_15_2_clang_64bit-Debug/_deps/noodles-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/5c19fd7179855675b814da36fa5f160cf760600e")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "5c19fd7179855675b814da36fa5f160cf760600e")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "5c19fd7179855675b814da36fa5f160cf760600e")
endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/lordzippy/Development/Noodles/NoodlesExplorer/build-src-Desktop_Qt_5_15_2_clang_64bit-Debug/_deps/noodles-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/lordzippy/Development/Noodles/NoodlesExplorer/build-src-Desktop_Qt_5_15_2_clang_64bit-Debug/_deps/noodles-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
